...
Generate a grounded answer using Azure OpenAI when configured
Show citations and retrieved evidence in the UI
Challenge alignment
...
Replace sample PDFs with your own challenge theme if needed
Add a short section describing your learning outcomes
